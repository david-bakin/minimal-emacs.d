...
;; Still loads minimal emacs configs `{pre,post}{-early}init.el` from ~/emacs.d
...
(setq native-comp-jit-compilation-deny-list `( "(pre-|post-)?(early-)?init\\.el" "bakin-init-my-packages\\.el" ))
